...
const routes = [
  ...
  { path: "/map-pathing", name: "pathing", component: () => import("@/pages/map-pathing.vue"), meta: { requires: true } },
  ...
  { path: "/script-groups", name: "script-groups", component: () => import("@/pages/script-groups.vue"), meta: { requires: true } }, // ✅已验证
